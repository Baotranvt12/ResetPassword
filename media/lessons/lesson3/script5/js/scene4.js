// <--chỗ đổ dữ liệu-->
var list3 = [
	'aaa aas aad aaf asa ass asd asfada ads add adf afa afs afd aff',
	'saa sas sad saf ssa sss ssd ssfsda sds sdd sdf sfa sfs sfd sff',
	'daa das dad daf dsa dss dsd dsfdda dds ddd ddf dfa dfs dfd dff',
	'faa fas fad faf fsa fss fsd fsffda fds fdd fdf ffa ffs ffd fff',
	// 'asd dfs sad dfa dsa dfa asd fda',
	// 'sda fda dsf asd fsa sdf fda asd',
]
var list3_index = 0;
// <--end chỗ đổ dữ liệu-->
