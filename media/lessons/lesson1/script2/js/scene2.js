...
class scene2 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('question1','assets/question1.png');
	...
	create(){
		...
		this.add.image(width/2, height - 450, 'label1');
		this.add.image(width - 770, height - 240, 'img1');
		this.add.image(width - 350, height - 350, 'question1');
