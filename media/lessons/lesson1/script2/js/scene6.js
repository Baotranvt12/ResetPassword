class scene6 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('question5','assets/question5.png');
	...
	create(){
		...
		this.add.image(width - (835 - 170*4), height - 540, 'bee');

		this.add.image(width/2, height - 250, 'rec');
		this.add.image(width/2, height - 450, 'label5');
		this.add.image(width - 800, height - 240, 'img5');
		this.add.image(width - 350, height - 350, 'question5');
