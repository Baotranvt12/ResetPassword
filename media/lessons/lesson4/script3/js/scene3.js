class scene3 extends Phaser.Scene{
	...
	//	this.load.image('img1','assets/img1.png');
		...
		this.load.image('keya', 'assets/keyK.png');
		this.load.image('keys', 'assets/keyJ.png');
		this.load.image('keyd', 'assets/keyL.png');
		this.load.image('keyf', 'assets/key;.png');
	}
	create(){
	...
	wrong.visible = false
		...
		this.add.image(360,410, 'point').setScale(0.7);
		...
		var s1 = this.add.sprite(920,500,'keya').setScale(0.7).setInteractive();
		...
		var s3 = this.add.sprite(700,300, 'keyd').setScale(0.8).setInteractive();
		...
		var s4 = this.add.sprite(920,310, 'keyf').setScale(0.8).setInteractive();
