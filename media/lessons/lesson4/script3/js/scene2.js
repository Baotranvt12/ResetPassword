...
class scene2 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('left1', 'assets/right1.png');
		this.load.image('incorrect', 'assets/incorrect.png');
		this.load.image('keya', 'assets/keyK.png');
		this.load.audio('tune', 'assets/tune.mp3');
	}
	create(){
// 		//var q1 = "Em hãy cho biết, chúng ta dùng ngón tay nào để gõ phím A?";
// 		//this.add.text(250, 100, q1, { font: '32px Arial',  color: '#ff0000' });
